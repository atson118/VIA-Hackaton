...
<main class="main">
    ...
    <section class="main_menu_box">
        ...
        <p class="menu_text">Гайды профессиий</p>
        <p class="guid_text">ТОП-10 профессий 2022 года | Актуальные вакансии будущего удаленно</p>
        <div class="video_box">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/YrX9fckbksI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <p class="guid_sub_text">Сегодня мы рассмотрим профессии, на которых можно работать удаленно и которые будут востребованы, как в России, так и за рубежом в 2022 году</p>

        <p class="guid_text">ТОП 15 профессий будущего — список актуальных профессий на 2021 год</p>
        <div class="video_box">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/rVYyuNYVNLY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <p class="guid_sub_text">Сегодня мы рассмотрим профессии, которые будут востребованы, как в России, так и за рубежом в 2021 году.</p>

        <p class="guid_text">27 ПРОФЕССИЙ БУДУЩЕГО (и у кого будущего нет)</p>
        <div class="video_box">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/LNKYlpstDjY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <p class="guid_sub_text">Источники информации - Forbes, Glassdoor и Monster. Ссылки на статьи нижу в описании. Если еще не поняли, кем быть, тренируйте мозг на Wikium - https://wikium.ru/t/udk63p5y</p>

...
<div class="container">
    ...
    <main class="main">
        ...
        <section class="main_menu_box">
            <p class="menu_text">Новости</p>
            <div class="menu">
                <div class="new_box">
                    <div class="new_img_box"><img src="img/news_img.png" alt="" class="new_img"></div>
                    <div class="new_text_box">
                        <p class="new_text">28 апреля прошло заседание рабочей 
                            группы представителей ЗАО «Сокол-АТС», 
                            в лице генерального директора 
                            Андреева Владимира Николаевича, 
                            руководителей образовательных 
                            организаций Белгородской области. 
                            Центр опережающей профессиональной 
                            подготовки представили 
                            Татьяна Сергеевна Салагина, начальник отдела опережающей 
                            профессиональной 
                            подготовки и Анастасия Викторовна Бессонова, 
                            заместитель директора.</p>
                    </div>
                    <div class="new_icon_box">
                        <img src="img/Comment.png" alt="" class="new_icon_message">
                        <img src="img/Share.png" alt="" class="new_icon_share">
                    </div>
                </div>
                
            </div>
            <div class="line_box"><hr class="news_line"></div>
            <div class="menu">
                <div class="new_box">
                    <div class="new_img_box"><img src="img/news_img.png" alt="" class="new_img"></div>
                    <div class="new_text_box">
...
<div class="footer_box">
    <div class="footer_nav_box">
        ...
        <div class="nav_past">
            <a href="chat-index.php" class="nav">Чат</a>
            <a href="quiz.html" class="nav">Новости</a>
        </div>
    </div>
    <div class="footer_form_box">
        <form action="php/ajax.php" method="POST" class="footer_message_box">

...
<main class="main">
    ...
    <section class="main_menu_box">
        <div class="map_box">
            <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A0751531060ee0a30ad536c63ef8343719cda40d79048e1fbaf4a16da6c2239b4&amp;source=constructor" width="100%" height="100%" frameborder="0"></iframe>   
        </div>  
    </section>
    </section>
    <section class="right">
